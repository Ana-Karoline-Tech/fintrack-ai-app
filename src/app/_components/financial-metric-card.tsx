...
export const FinancialMetricCard = ({
    ...
    return (
        <article
            className="flex flex-col items-center justify-between gap-6 rounded-[24px] border border-slate-800 bg-slate-950/95 p-6 text-center shadow-[0_25px_80px_-50px_rgba(15,23,42,0.8)]"
            style={{ width: "357.34px", height: "254px" }}
        >
