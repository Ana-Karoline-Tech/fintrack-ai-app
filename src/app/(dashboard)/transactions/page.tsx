...
export default async function TransactionsPage() {
  ...
  return (
    <main className="space-y-6 p-8 font-(family-name:--font-inter) overflow-auto flex-1">
      ...
      <section className="overflow-x-auto rounded-3xl border border-[rgba(255,255,255,0.1)] bg-[rgba(30,41,59,0.8)] shadow-[0px_8px_10px_-6px_rgba(0,0,0,0.2),0px_20px_25px_-5px_rgba(0,0,0,0.2)]">
